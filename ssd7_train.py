...
from SSD.ssd7 import build_model
...
from SSD.data_generator.data_augmentation_chain_variable_input_size import DataAugmentationVariableInputSize
from SSD.data_generator.data_augmentation_chain_constant_input_size import DataAugmentationConstantInputSize
...
n_classes =27  # Number of positive classes
...
# Images
images_dir = "flickr_logos_27"

# Ground truth
train_labels_filename = "flickr_train.csv"
val_labels_filename   = "flickr_valid.csv"

train_dataset.parse_csv(images_dir=images_dir,
                        labels_filename=train_labels_filename,
                        input_format=['image_name', 'class_id','class','xmin', 'xmax', 'ymin', 'ymax' ], # This is the order of the first six columns in the CSV file that contains the labels for your dataset. If your labels are in XML format, maybe the XML parser will be helpful, check the documentation.
                        include_classes='all')

val_dataset.parse_csv(images_dir=images_dir,
                      labels_filename=val_labels_filename,
                      input_format=['image_name', 'class_id', 'class','xmin', 'xmax', 'ymin', 'ymax' ],
                      include_classes='all')
