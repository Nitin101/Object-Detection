...
# Ground truth
train_labels_filename = "voc07_train.csv"
val_labels_filename   = "voc07_val.csv"

train_dataset.parse_csv(images_dir=images_dir,
                        labels_filename=train_labels_filename,
                        input_format=['image_name','class', 'class_id','xmin', 'ymin', 'xmax', 'ymax' ], # This is the order of the first six columns in the CSV file that contains the labels for your dataset. If your labels are in XML format, maybe the XML parser will be helpful, check the documentation.
                        include_classes='all')

val_dataset.parse_csv(images_dir=images_dir,
                      labels_filename=val_labels_filename,
                      input_format=['image_name', 'class','class_id','xmin', 'ymin', 'xmax', 'ymax' ],
                      include_classes='all')
